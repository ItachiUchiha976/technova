...
(function () {
  ...
  function decode() {
    ...
    if (order.length === 0) {
      ...
      out += '<a class="decoder-next" href="https://technovaboutique.fr/comparateur" target="_blank" rel="sponsored nofollow noopener">🧠 Tu veux choisir le bon outil IA&nbsp;? → Voir le comparateur gratuit</a>';
      detEl.innerHTML = out;
    }
  ...
  function startQuiz() {
    ...
    function renderEnd() {
      ...
      quizBox.innerHTML =
        ...
        '<a class="btn btn-primary" href="https://technovaboutique.fr/comparateur" target="_blank" rel="sponsored nofollow noopener">Trouver mon outil IA →</a>' +
        "</div>";
